...
\begin{table}
	...
	\caption{Statistical values used to evaluate the predictions.}
...
\begin{figure}[h]
	...
	\caption{Laboratory Earthquake Experiment Design}
	\label{fig:lab}
\end{figure}
